...
Ported from bilibili2text ``b2t/download/platform.py`` into the iHateVideos
project as the ``ihatevideos.input`` module. Behaviour is unchanged; only the
import path moved (``b2t.*`` -> ``ihatevideos.input.*``).
"""
